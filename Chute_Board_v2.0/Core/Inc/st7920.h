/*
 * st7920.h
 * Downloaded on: 15-MAY-2024
 * Downloader: Le Huu An
 */
...
/*DECLARE FUNCTION*/
	...
	void SendByteSPI(uint8_t byte);		// A replacement for SPI_TRANSMIT

	void ST7920_SendCmd (uint8_t cmd);		// Send the command to the LCD
	
	void ST7920_SendData (uint8_t data);		// send the data to the LCD
...
/*EXTERN*/
	...
	extern const unsigned char Yody[];
