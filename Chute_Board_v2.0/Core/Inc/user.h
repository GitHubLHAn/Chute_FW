...
/*DEFINE*/
	...
	#define		CHUTE_FULL 		 	0x02
	#define		CHUTE_CLOSE 		0x01
	...
	#define TOGGLE_LED_RED( )		HAL_GPIO_TogglePin(THAPLED_REG_GPIO_Port, THAPLED_REG_Pin)
	...
	#define TOGGLE_LED_GREEN( )		HAL_GPIO_TogglePin(THAPLED_GREEN_GPIO_Port, THAPLED_GREEN_Pin)
	...
	#define TOGGLE_LED_YELLOW( )		HAL_GPIO_TogglePin(THAPLED_YELLOW_GPIO_Port, THAPLED_YELLOW_Pin)
	...
	#define TOGGLE_SPEAKER( )		HAL_GPIO_TogglePin(THAPCOI_GPIO_Port, THAPCOI_Pin)
